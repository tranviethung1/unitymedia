                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @foreach($works as $item)
                            <tr class="odd gradeX" align="center">
                                <td>{{ $item->id }}</td>
                                <td>
                                    <img width="100px" src="{{asset('upload/work/')}}/{{ $item->file }}">
                                </td>
                                <td>{{ $item->title }}</td>
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="{{asset('admin/work/')}}/{{ $item->id }}/edit">Edit</a></td>
                                <td class="center">
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>You sure delete work: "{{$item->name}}"?</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <form method="POST" action="{{ asset('admin/work/delete/' .$item->id) }}">
                                                        {{ csrf_field() }}
