                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @foreach($radio as $item)
                            <tr class="odd gradeX" align="center">
                                <td>{{ $item->id }}</td>
                                <td>
                                    <img width="100px" src="{{asset('upload/radio/')}}/{{ $item->file }}">
                                </td>
                                <td>{{ $item->name }}</td>
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="{{asset('admin/radio/')}}/{{ $item->id }}/edit">Edit</a></td>
                                <td class="center">
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>You sure delete radio: "{{$item->name}}"?</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <form method="POST" action="{{ asset('admin/radio/delete/' .$item->id) }}">
                                                        {{ csrf_field() }}
